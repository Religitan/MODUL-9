...
Pohon *insertLeft(char data, Pohon *node)
{
    ...
    else
    {
        if (node->left != NULL)
        {
            cout << "\n Node " << node->data_gita_2311102025 << " sudah ada child kiri !" << endl;
        ...
        else
        {
            ...
            cout << "\n Node " << data << " berhasil ditambahkan ke child kiri " << baru->parent->data_gita_2311102025 << endl;
...
Pohon *insertRight(char data, Pohon *node)
{
    ...
    else
    {
        if (node->right != NULL)
        {
            cout << "\n Node " << node->data_gita_2311102025  << " sudah ada child kanan !" << endl;
        ...
        else
        {
            ...
            cout << "\n Node " << data << " berhasil ditambahkan ke child kanan " << baru->parent->data_gita_2311102025  << endl;
            return baru; // Mengembalikan pointer ke node baru
        }
    }
}
...
void update(char data, Pohon *node)
{
    ...
    else // Jika tree tidak kosong
    {
        ...
        {
            char temp = node->data_gita_2311102025 ;                                   // Menyimpan data lama
            node->data_gita_2311102025  = data;                                        // Mengganti data dengan data baru
...
void retrieve(Pohon *node) // Fungsi retrieve dengan parameter pointer ke node dari Pohon
{
    ...
    else // Jika tree tidak kosong
    {
        ...
        {
            cout << "\n Data node : " << node->data_gita_2311102025  << endl; // Tampilkan data node yang ditunjuk
        }
    }
}
...
void find(Pohon *node) // Fungsi untuk menemukan dan menampilkan informasi tentang node dalam pohon
{
    ...
    else
    {
        ...
        {
            cout << "\n Data Node : " << node->data_gita_2311102025 << endl; // Tampilkan data dari node yang ditunjuk
            cout << " Root : " << root->data_gita_2311102025  << endl;        // Tampilkan data dari root node
...
void deleteSubtree(Pohon *node) // Fungsi untuk menghapus subtree yang dimulai dari node yang diberikan
{
    ...
    cout << "\n Node " << node->data_gita_2311102025  << " berhasil dihapus." << endl;
...
void showChildAndDescendant(Pohon *node) // Fungsi untuk menampilkan informasi tentang child dan descendant dari suatu node
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
                cout << " Child Kiri : " << node->left->data_gita_2311102025 << endl; // Tampilkan data dari child kiri
            ...
            {
                cout << " Child Kanan : " << node->right->data_gita_2311102025  << endl; // Tampilkan data dari child kanan
...
void findParent(Pohon *node, char parentData, Pohon *&parentNode) // Fungsi untuk mencari parent dari node dengan data tertentu
{
    ...
    if (node->data_gita_2311102025 == parentData) // Jika data node sama dengan data parent yang dicari
    {
...
int main()
{
    ...
    do
    {
        ...
        case 4: // Menu untuk mengupdate data pada node
        {
            ...
            {
                if (node->left && node->left->data_gita_2311102025  == nodeData)
                {
                    node = node->left; // Jika node pada left child sesuai dengan nodeData, pindahkan node ke left child
                }
                else if (node->right && node->right->data_gita_2311102025  == nodeData)
                {
